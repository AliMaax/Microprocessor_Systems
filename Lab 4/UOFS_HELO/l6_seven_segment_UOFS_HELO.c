/******************************************************************************
*	Project name: LAB 6
*	File name: l6_seven_segment_HELO
*	Author: Ali Maaz
*	Date: 2 Nov, 2025
...
/*lut for display1*/
const char lut_display1[4]={0xC1,//U --> 11000001 (0xC1)  for general hex-mapping
							0xC0,//O --> 11000000 (0xC0)
							0x8E,//F --> 10001110 (0x8E)
							0x92 //S --> 10010010 (0x92)
							};
							
/* lut for display2 */
const char lut_display2[4]={0x89,//H --> 10001001 (0x89)  for general hex-mapping
